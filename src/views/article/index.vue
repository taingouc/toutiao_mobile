    ...
    <div class="main-wrap">
      ...
      <div class="article-detail" v-else-if="article.title">
        ...
        <van-cell class="user-info" center :border="false">
          ...
          <follow-user class="follow-btn" :isFollowed="article.is_followed" :articleArtId="article.aut_id" @update-is_followed="article.is_followed = $event"></follow-user>
...
export default {
  ...
  components: { 'follow-user': FollowUser },
  created() {
    this.loadArticle()
  }
}
